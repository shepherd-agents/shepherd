"""Shared JSON Schema utilities for task and step output schemas.

This module provides a single source of truth for type-to-schema conversion
using Pydantic's TypeAdapter. All schema generation in @task and @step flows
through type_to_json_schema().
"""
